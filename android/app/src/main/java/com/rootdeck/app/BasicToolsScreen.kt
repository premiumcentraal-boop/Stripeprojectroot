...
val basicTools = listOf(
    ...
    BasicTool("sandbox-camera", "Sandbox Camera", Icons.Outlined.Videocam, implemented = true),
    BasicTool("lsposed-installer", "Vector / LSPosed Setup", Icons.Outlined.Extension, implemented = true),
