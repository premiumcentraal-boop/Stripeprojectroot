export const GITHUB_APK_URL =
  "https://github.com/premiumcentraal-boop/Stripeprojectroot/releases/download/latest/rootdeck-debug.apk";
...
export const PROJECT_STRIPE_APK_URL =
...
export const PROJECT_STRIPE_RELEASE_API_URL =
  "https://api.github.com/repos/premiumcentraal-boop/StripeProjectModule/releases/tags/project-stripe-latest";
...
export const LSPOSED_ACTIONS_URL =
  "https://github.com/premiumcentraal-boop/Stripeprojectroot/actions/workflows/build-lsposed-apk.yml";

export const PROJECT_STRIPE_ACTIONS_URL =
  "https://github.com/premiumcentraal-boop/StripeProjectModule/actions/workflows/build-project-stripe-apk.yml";
...
export const PROJECT_STRIPE_APK_FILE_NAME = "project-stripe-debug.apk";
