              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-6 text-slate-400">
                      Updated RootDeck Android 14+ APK with the RootDeck-only Sandbox Camera, scoped LSPosed bridge logs, saved Video Test Feed config, and repeat playback testing.
                    </p>
                  </div>
                  <Download className="size-5 shrink-0 text-emerald-300 transition group-hover:translate-y-0.5" />
                </div>
                <div className="mt-4 font-mono text-xs text-emerald-200/80">rootdeck-debug.apk · latest tag · scoped sandbox bridge build</div>
              </a>
